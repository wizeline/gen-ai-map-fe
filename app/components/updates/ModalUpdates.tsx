...
export const ModalUpdates: React.FC<ModalUpdatesProps> = ({
  notifications,
  onClose,
  className,
}) => {
  return (
    <div
      className={`w-[280px] h-64 max-h-64 border border-top-nav-border rounded overflow-hidden ${className}`}
    >
      <div className="flex justify-between items-center bg-primary text-white p-2 rounded-t">
        <h2 className="ml-2 font-bold text-sm leading-normal font-montserrat">
          What’s new?
        </h2>
        ...
        {notifications.map((notification) => (
          <div key={notification.id} className="flex items-start pb-2">
            ...
            <div className="h-[68px]">
              <p className="text-xs font-light leading-3 text-blue300 overflow-hidden mb-2">
              ...
              <a
                ...
                className="text-sm font-bold text-blue-400 overflow-hidden"
              >
